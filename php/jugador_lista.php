<?php
	...
	/*$campos="producto.id,producto.producto_codigo,producto.producto_nombre,producto.producto_precio,producto.producto_stock,producto.producto_foto,producto.categoria_id,producto.usuario_id,categoria.categoria_id,categoria.categoria_nombre,usuario.usuario_id,usuario.usuario_nombre,usuario.usuario_apellido";
    ...
    foreach($datos as $dato){
        echo "id".$dato['idJugador']; 
        echo "nombre".$dato['nombre']; 
        echo "apellido".$dato['apellido']; 
        echo "edad".$dato['edad']; 
        echo "equipo".$dato['equipo']; 
        echo "camiseta".$dato['camiseta']; 
        echo "posicion".$dato['posicion']; 
    }
